...
messages = ['you can do it!', "don't get eaten!", 'run, forrest, run!', "where there's a will, there's a way", "you can beat it!", "outsmart the snake!"]
message = None
...
with term.cbreak(), term.hidden_cursor():
  ...
  print('lot harder than you might think ;)')
